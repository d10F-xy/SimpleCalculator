...
![과제2 실행화면](img/과제2-1.png)
![과제2 실행화면](img/과제2-2.png)
![과제2 실행화면](img/과제2-3.png)
![과제2 실행화면](img/과제2-4.png)
![과제2 실행화면](img/과제2-5.png)

- 과제내용
1. 빼기, 곱하기, 나누기 구현하기
2. 뺄셈(-), 곱셈(*), 나눗셈(/) 버튼 추가
3. 이벤트 연결 및 버튼 클릭 시 연산자만 변경하여 동일 로직 적용


- 구현 내용과 기능 설명
1. 뺄셈(-), 곱셈(*), 나눗셈(/) 버튼 추가  
2. 각 버튼에 이벤트 연결  
3. 버튼 클릭 시 연산자만 변경하여 기존 계산 로직 재사용

- 숫자 입력 기능: 기존과 동일, InputBox에 숫자 표시  
- 연산자 선택 기능: 버튼 클릭 시 `op` 변수에 선택된 연산자 저장  
- `=` 버튼 클릭 → 두 번째 숫자 입력 후 계산 수행  
- 결과 표시: InputBox와 OutputBox에 계산 결과 표시  
- 기존 기능 그대로 유지: CE, DEL, ±, . 버튼 및 진법 변환 가능

## 실행화면(과제3)
-과제3 코드의 실행 스크린샷

![과제3 실행화면](img/과제3-1del.png)

- 삭제 이전
![과제3 실행화면](img/과제3-2del.png)
- 
- 삭제 이후
![과제3 실행화면](img/과제3-3.png)
- 
- C 버튼 클릭 이전
![과제3 실행화면](img/과제3-4.png)
- 
- C 버튼 클릭 이후
![과제3 실행화면](img/과제3-5.png)
- 
- CE 버튼 클릭 이전
![과제3 실행화면](img/과제3-6.png)
- 
- CE 버튼 클릭 이후
...
- 초기 상태로 되돌림
3. CE 버튼
- 마지막 입력한 피연산자(Operand) 값만 삭제
- 예: 100 입력 후 CE → 100 값이 통째로 삭제됨
4. Del 버튼
- 마지막 입력된 글자 하나(숫자 하나)만 삭제
- 예: 100 입력 후 Del → 10 으로 변경됨
...
- C 버튼: 전체 초기화  
- CE 버튼: 현재 입력 중인 숫자만 제거  
- Del 버튼: 마지막 입력 글자 삭제  
- 계산 로직은 기존 입력값과 연산자 구조를 그대로 사용   

## 실행화면(과제4)
-과제4 코드의 실행 스크린샷

![과제4 실행화면](img/과제4-1.png)
![과제4 실행화면](img/과제4-2.png)
![과제4 실행화면](img/과제4-3.png)
![과제4 실행화면](img/과제4-4.png)
![과제4 실행화면](img/과제4-5.png)
![과제4 실행화면](img/과제4-6.png)

- 과제내용
1. Windows 계산기 참고
- 어떤 편의 기능이 있는지 자세히 살펴보기
- 숨어있는 기능도 찾아보기
- 내 프로그램도 똑같이 동작하도록 구현
2. 추가 기능 구현
- 놀랄만한 멋진 기능을 추가
- 마음껏 능력을 발휘하여 창의적인 기능 구현

- 구현 내용과 기능 설명

1. 2진수 8진수 16진수 변환 기능 추가  
   - InputBox의 숫자를 선택한 진법으로 변환하여 표시  
   - OutputBox에도 변환 결과 표시
2. 연산자 우선순위 처리
